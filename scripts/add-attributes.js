...
(async () => {
    try {
        await db.createStringAttribute(process.env.NEXT_PUBLIC_APPWRITE_DATABASE_ID, process.env.NEXT_PUBLIC_COLLECTION_QUESTIONS, 'tags', 255, false, null, true); // array=true
        console.log('Added tags array attribute');
