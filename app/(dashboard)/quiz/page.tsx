            ...
            <div className="space-y-6">
              ...
              {mockConfigSubject ? (
                <div className="max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-300">
                  <button onClick={() => setMockConfigSubject(null)} className="flex items-center gap-2 text-sm font-bold text-gray-400 hover:text-gray-900 mb-8 transition-colors">
                  ...
                  <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm p-8 space-y-10">
                      ...
                      <div>
                        ...
                        <div className="flex gap-3 flex-wrap">
                          {QUESTION_COUNT_OPTIONS.map(n => (
                            <button key={n} onClick={() => setMockQuestionCount(n)}
                              className={`px-5 py-3 rounded-2xl font-black text-sm transition-all border-2 ${mockQuestionCount === n ? 'bg-[#4A90E2] border-[#4A90E2] text-white shadow-lg shadow-blue-100 scale-105' : 'bg-white border-gray-100 text-gray-500 hover:border-gray-300 hover:text-gray-700'}`}
                            >{n}</button>
                          ))}
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="flex gap-3 flex-wrap">
                        {DIFFICULTY_OPTIONS.map(d => (
                          <button key={d} onClick={() => setMockSelectedDifficulty(d)} className={getDifficultyStyle(d, mockSelectedDifficulty === d)}>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <div className="bg-gray-50 rounded-2xl p-4 text-center">
                        <p className={`text-xl font-black ${mockSelectedDifficulty === 'Easy' ? 'text-green-600' : mockSelectedDifficulty === 'Medium' ? 'text-amber-500' : mockSelectedDifficulty === 'Hard' ? 'text-red-500' : 'text-gray-900'}`}>{mockSelectedDifficulty}</p>
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1">Difficulty</p>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <button onClick={handleStartMockPractice} disabled={mockStartLoading}
                      ...
                      {mockConfigSubject.count > 50 && (
                        <button onClick={handleStartMockFullLength} disabled={mockStartLoading}
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex items-start justify-between mb-8">
                                ...
                                <div className={`text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full ${accent.bg} ${accent.text}`}>Mock</div>
                              </div>
                    ...
                    : subjects.map(subj => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <h3 className="text-2xl font-black text-gray-900 mb-2">{subj.Name}</h3>
                            <p className="text-[11px] font-black text-gray-300 uppercase tracking-widest flex items-center gap-2"><FileText className="h-3 w-3" /> {subj.count} questions</p>
